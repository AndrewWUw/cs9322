 ...
 * importMarketDataResponse(@http://sltf.unsw.edu.au/services) element.
 * 
 * This is a complex type.
 */
public class ImportMarketDataResponseDocumentImpl extends
		org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements
		au.edu.unsw.sltf.services.ImportMarketDataResponseDocument {

	public ImportMarketDataResponseDocumentImpl(
			org.apache.xmlbeans.SchemaType sType) {
		super(sType);
	}

	private static final javax.xml.namespace.QName IMPORTMARKETDATARESPONSE$0 = new javax.xml.namespace.QName(
			"http://sltf.unsw.edu.au/services", "importMarketDataResponse");
	...
	public au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse getImportMarketDataResponse() {
		synchronized (monitor()) {
			...
			target = (au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse) get_store()
					.find_element_user(IMPORTMARKETDATARESPONSE$0, 0);
			if (target == null) {
				return null;
			}
			return target;
	 ...
	 */
	public void setImportMarketDataResponse(
			au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse importMarketDataResponse) {
		synchronized (monitor()) {
			check_orphaned();
			au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse target = null;
			target = (au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse) get_store()
			...
			if (target == null) {
				target = (au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse) get_store()
						.add_element_user(IMPORTMARKETDATARESPONSE$0);
			}
	 ...
	 * This is a complex type.
	 */
	public static class ImportMarketDataResponseImpl extends
			org.apache.xmlbeans.impl.values.XmlComplexContentImpl
			implements
			au.edu.unsw.sltf.services.ImportMarketDataResponseDocument.ImportMarketDataResponse {

		public ImportMarketDataResponseImpl(org.apache.xmlbeans.SchemaType sType) {
			super(sType);
		}

		private static final javax.xml.namespace.QName EVENTSETID$0 = new javax.xml.namespace.QName(
				"http://sltf.unsw.edu.au/services", "eventSetId");
		...
		public java.lang.String getEventSetId() {
			synchronized (monitor()) {
				...
				target = (org.apache.xmlbeans.SimpleValue) get_store()
						.find_element_user(EVENTSETID$0, 0);
				if (target == null) {
					return null;
				}
